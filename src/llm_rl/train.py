...
from llm_rl.models.load import load_lora_policy_model_and_tokenizer, tokenize_chat_prompts
...
def parse_args() -> TrainConfig:
    ...
    ap.add_argument("--logprob_batch_size", type=int, default=TrainConfig.logprob_batch_size)
...
def main():
    ...
    if cfg.logprob_batch_size <= 0:
        raise ValueError(f"logprob_batch_size must be >= 1, got {cfg.logprob_batch_size}")
    ...
    for step in pbar:
        ...
        rollout_out = sampler.rollout(
            ...
            logprob_batch_size=cfg.logprob_batch_size,
        )
